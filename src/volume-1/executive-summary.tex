...
The investigation continued under then-Director Comey for the next seven weeks until May~9, 2017, when President Trump fired Comey as FBI Director---an action which is analyzed in \hyperlink{chapter.2}{Volume~II} of the report.
...
Those and related actions are described and analyzed in \hyperlink{chapter.2}{Volume~II} of the report.

\hr

\subsection*{The Special Counsel's Charging Decisions}

In reaching the charging decisions described in \hyperlink{chapter.1}{Volume~I} of the report, the Office determined whether the conduct it found amounted to a violation of federal criminal law chargeable under the Principles of Federal Prosecution.
