...
\textit{See} Volume~I, Section~IV.A.7, \textit{supra}.}
...
\footnote{Hicks 12/8/17 302, at~21.
The \textit{Access Hollywood} tape was released on October~7, 2016, as discussed in Volume~I, Section~III.D.1, \textit{supra}.}
...
\textit{See} Volume~II, Section~III, \textit{infra}.
...
\textit{See} Volume~II, Section~II.G, \textit{infra}.
